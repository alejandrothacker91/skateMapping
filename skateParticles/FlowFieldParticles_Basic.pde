...
/*
 ...
 viewport_w = (int) min(viewport_w, displaypoolX  * 0.9f);
 viewport_h = (int) min(viewport_h, displaypoolY * 0.9f);
...
public void setupParties() {
  ...
  PGraphics2D pg_gravity = (PGraphics2D) createGraphics(poolX, poolY, P2D);
  pg_gravity.smooth(0);
...
void updateScene() {
  ...
  pg_obstacles.rect(100, 100, w-200, h-200);
